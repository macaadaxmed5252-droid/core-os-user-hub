...
export default function AboutPage({ setCurrentPage, isDarkMode }) {
  return (
    <div className="space-y-8 animate-fadeIn">
      {/* HERO SECTION */}
      <div className="relative border rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden flex flex-col items-center text-center group transition-all duration-500 
        ...
        <h1 className="text-3xl md:text-5xl font-black tracking-tight max-w-2xl leading-tight text-slate-900 dark:text-white">
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center z-10">
          <button 
            ...
            className="bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-bold text-xs uppercase tracking-wider py-3.5 px-6 rounded-xl shadow-lg transform hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
          >
            Get Started (Open Form)
          </button>
          <button 
            onClick={() => setCurrentPage('directory')}
            className="border font-bold text-xs py-3.5 px-6 rounded-xl transform hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="border backdrop-blur-md rounded-2xl p-6 shadow-xl transform hover:-translate-y-1 transition-all duration-300 group 
          ...
          dark:bg-neutral-900/60 dark:border-neutral-800/80 dark:hover:border-emerald-500/30">
      ...
      <div className="p-6 rounded-2xl border flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-100 border-slate-200 dark:bg-neutral-950 dark:border-neutral-800">
        ...
        <div className="flex space-x-2 text-[10px] font-mono font-bold uppercase">
